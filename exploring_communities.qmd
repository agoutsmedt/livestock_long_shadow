...
alluvial <- read_rds(file.path(data_path, "parameter_comparison_data", glue("alluvial_round2_{params$method}_{params$threshold}_{params$window}_{params$resolution}.rds")))
