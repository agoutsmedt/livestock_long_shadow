...
# Most cited references
  ...
  cat("In the next table, you will find the ten references that are the most cited by the community")
   ...
   print(kbl(most_cited_references[cluster_label == com, -c("cluster_label")],
            col.names = c("First Author","Year","Title","Journal", "Abstract", "Link", "Citations")) %>% 
